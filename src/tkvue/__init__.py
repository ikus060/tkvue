...
class computed_property(Observable):
    ...
    def _dependency_change(self, new_value):
        """
        When our dependencies get updated, make our self dirty and notify our watchers
        """
        # TODO We could optimize here to avoid sending notification when the computed value is the same.
        self._dirty = True
...
class _Context:
    ...
    def __getitem__(self, key):
        """
        Used by `eval()` to resolve variable name
        Return the `.value`
        """
