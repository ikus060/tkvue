...
<TopLevel title="TKVue example" geometry="500x500">
    ...
    <Frame fill="x">
        ...
        <Button text="width=45" style="left.TButton" pady="0 15" width="45"/>
    </Frame>

    <Frame fill="x" >
        <label text="Stacked on the left" />
        <Button text="side=left" pady="0 15" padx="0 5" side="left"/>
        <Button text="side=left" pady="0 15" padx="0 5" side="left"/>
        <Button text="side=left" pady="0 15" padx="0 5" side="left"/>
    </Frame>
    ...
    <Frame fill="both" expand="1">
        ...
        <Button text="fill=x" pady="0 15" fill="x"/>

        <label text="Take all horizontal space" />
        <Button text="fill=y expand=1" pady="0 15" fill="y"  expand="1"/>

        <label text="Take all vertical & horizontal space" />
        <Button text="fill=both expand=1" pady="0 15" fill="both"  expand="1"/>
