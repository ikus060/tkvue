...
class ErrorFrame(tkvue.Component):
    template = """
<Frame style="error.TFrame" fill="x" expand="1" padding="4 1 1 1">
    <Frame style="default.TFrame" fill="x" expand="1" padding="10">
        <Label style="default.TLabel" text="{{text}}" side="left"/>
        <Label style="default.TLabel" text="{{subtext}}" side="left" />
    </Frame>
</Frame>
"""
...
<TopLevel title="TKVue Test" geometry="450x350" >
    <Frame style="default.TFrame" fill="both" expand="1" padding="25">
